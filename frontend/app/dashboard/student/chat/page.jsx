  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Communicate with mentors and team members</p>
      </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3 p-2 rounded-md bg-primary/10 cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">Let's discuss your progress...</p>
                </div>
              ...
              <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50 cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium">Prof. Robert King</p>
                  <p className="text-xs text-muted-foreground truncate">Your project submission looks good</p>
                </div>
                <div className="flex flex-col items-end">
              ...
              <div className="flex items-center gap-3 p-2 rounded-md hover:bg-muted/50 cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">Emily: When is our next meeting?</p>
                </div>
                <div className="flex flex-col items-end">
